...
async def rebuild_database():
    ...
    # Define Headers
    headers = ["local_id", "Sala", "Predio", "Andar", "TipoAmbiente", "Modelo", "BIOS", "TotalPCs", "Concluidos", "Pendentes", "Erros", "Status", "Observacao", "Setor", "UltimoResponsavel", "UltimoContato", "UltimaAtualizacao"]
